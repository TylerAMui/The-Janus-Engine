...
st.title("🏛️ The Janus Engine v9.5a: The General's Toolkit")
...
# v9.5a: Update version number
st.markdown("""
The Janus Engine (v9.5a) leverages advanced AI (Gemini 2.5 Pro) to help you analyze creative works—text, images, audio, or video—from multiple perspectives simultaneously. 
